...
export const InitialPageText = () => <>
  ...
  <p>
    Please note: this is a living document and is still in a draft stage</p>

  <h4>How long do pedestrians wait at traffic signals around the world?</h4>
  <p>Below are some rough estimates of the maximum wait time for pedestrians
    at traffic lights around the world.
    Please see the <a href="/">map</a> for source measurements.</p>
  <p>Note that whether pedestrians have a <i>protected phase</i>
    has a large impact on the wait time. Cities that have
    reduced traffic volumes and vehicle speeds to 30km/h achieve safe streets
    without protected pedestrian phases (eg. Copenhagen). Other cities have advanced
    signal phasing to prioritise pedestrians using multi stage crossings to permit
    pedestrians to cross whenever possible.
  </p>
  <p> Max pedestrian waits:</p>
  <p><a href="https://www.cityofsydney.nsw.gov.au/strategies-action-plans/city-walking-strategy-action-plan-continuing-vision">
    City of Sydney target:</a> maximum wait time for pedestrians of 45 seconds with a target of 30 seconds.</p>
    <p>Corrections to this list are welcome - please <a href="mailto:jake@jakecoppinger.com">contact me</a>,
    <a href="https://betterintersections.jakecoppinger.com/contribute-measurement">contribute a measurement</a>,
    <a href="https://github.com/jakecoppinger/better-intersections/blob/main/src/pages/analysis/copy-text.tsx">submit a PR to 
    edit this page</a>, or release open signal timing data for your city.
    </p>

  <p>
    {
      /* - **SCATS**
    - Sydney CBD: 80-110 seconds
    - Singapore: 126s
    - Queenstown: 85-107s
      - **Non-SCATS**
    - Amsterdam: 24-71s (overestimate)
    - Paris: 35-60s
    - Copenhagen: 45s
    - Aarhus: 47-52s
    - Oslo: 33s (68 over arterial)
    - Barcelona: 59s
    - Utrecht: 20-40s (overestimate) */}
    <ul>
      <li>Cities using SCATS</li>
      <ul>
        <li>Sydney CBD: 80-110 seconds max wait (90-100s cycle time)</li>
        <li>Singapore: 105-126s max wait (
          <a href="https://betterintersections.jakecoppinger.com/intersection/node/7926827155">115</a>-<a href="https://betterintersections.jakecoppinger.com/intersection/node/6208991348">
        146s</a> cycle time)</li>
        <li>Queenstown: 85-107s max wait (<a href="https://betterintersections.jakecoppinger.com/intersection/node/12663542204">90</a>-<a href="https://betterintersections.jakecoppinger.com/intersection/node/11005599123">
        113s</a> cycle time)</li>
      </ul>
