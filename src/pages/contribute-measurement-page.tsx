...
type AuthState = "no-login-email-sent" | "sending-email" | "waiting-on-code" | "checking-code" | "logged-in";
    ...
    <HeaderAndFooter>
      <div>
        ...
        <p>
          ...
          {!session && (authState === "no-login-email-sent" || authState === "sending-email") && 
            <form
          ...
          {!session && (authState === "waiting-on-code" || authState === "checking-code" )&&
            <div>
        ...
        {session && <AuthenticatedForm key={session.user.id} session={session} />}
