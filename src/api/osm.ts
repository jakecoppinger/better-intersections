...
export async function getOsmNodePosition(osmNode: string): Promise<{ lat: number, lon: number, tags: Record<string, string> }> {
...
export async function fetchOsmWaysForNode(nodeId: string): Promise<Way[]> {
